...
async def send_welcome(message: types.Message):
    await message.reply(
        ...
        "Вы можете составить отчет с помощью голоса, отправьте голосовое сообщение. \n"
        "\nТакже вы можете заполнить отчет в текстовом формате с помощью команды /fill_report\n"
        "Когда убедитесь, что все данные верны и картинки заполнены нажмите кнопку на экранной клавиатуре 'Создать отчет в файле docx'.\n"
        "\n/info - нажмите чтобы увидеть дополнительную информацию.",
    )
...
async def send_info(message: types.Message):
    await message.reply(
        ...
        "clear - Очистить историю диалога с ИИ\n"
        "/fill_report - Составить отчет пошагово\n"
        "/view_report - Просмотреть текущий отчет\n"
        "/reset_report - Очистить текущий отчет\n"
        "/skip - Пропустить этап в создании отчета пошагово\n"
        "/cancel - Отменить создание отчета пошагово\n",
    )
